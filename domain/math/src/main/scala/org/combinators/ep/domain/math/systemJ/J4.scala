...
import org.combinators.ep.domain.math.systemJ.J3.{Divd, DivdInst, Neg, NegInst, PrettyP, StringInst}
...
object J4 extends Evolution {
  ...
  override def allTests: Map[GenericModel, Seq[TestCase]] = allPastTests(J3)
