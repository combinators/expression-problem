...
//}
///*
// * interpreter solution in java for M8
// *
// * @group evolutions
// */
//class M8_Variation @Inject()(web: WebJarsUtil, app: ApplicationLifecycle) extends Foundation(web, app) {
//override val gen = new WithDomain(math.MathDomain) with InterpreterGenerator with InterpreterTestGenerator with e0 with e1 with e2 with e3 with e4 with e5 with e6 with e7 with e8
//}
///*
