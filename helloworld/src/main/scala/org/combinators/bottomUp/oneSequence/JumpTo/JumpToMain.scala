...
import org.combinators.model.{ArgExpression, CharAtExpression, EqualExpression, InputExpression, IntegerArrayType, IteratorExpression, LiteralChar, LiteralInt, Model, StringLengthExpression, StringType, SubproblemExpression, SubtractionExpression, lessThanExpression, ArrayLengthExpression}
...
object DPDirectToDiskMain extends IOApp {
  ...
  def run(args: List[String]): IO[ExitCode] = {
    ...
    val bound = List(new ArgExpression(0, "array", new IntegerArrayType()))
