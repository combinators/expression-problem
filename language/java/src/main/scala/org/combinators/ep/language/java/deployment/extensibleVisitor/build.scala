...
import org.combinators.ep.language.java.extensibleVisitor.{ExtensibleVisitorGenerator, ExtensibleVisitorTestGenerator, Foundation}
import org.webjars.play.WebJarsUtil
import play.api.inject.ApplicationLifecycle
/* 
 * extensibleVisitor solution in j for M0
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for M1
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for M2
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for M3
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for M4
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for M5
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for M6
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for I1
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for I2
 * 
 * @group evolutions 
 */
...
/* 
 * extensibleVisitor solution in j for C1
 * 
 * @group evolutions 
 */
class C1_Variation @Inject()(web: WebJarsUtil, app: ApplicationLifecycle) extends Foundation(web, app) {
override val gen = new WithDomain(MathDomain) with ExtensibleVisitorGenerator with ExtensibleVisitorTestGenerator with e0 with e1 with i1 with i2 with e2 with e3 with c1
}
/*
 * extensibleVisitor solution in j for P1
 *
 * @group evolutions
 */
class P1_Variation @Inject()(web: WebJarsUtil, app: ApplicationLifecycle) extends Foundation(web, app) {
  override val gen = new WithDomain(MathDomain) with ExtensibleVisitorGenerator with ExtensibleVisitorTestGenerator with e0 with e1 with e2 with p1
}
