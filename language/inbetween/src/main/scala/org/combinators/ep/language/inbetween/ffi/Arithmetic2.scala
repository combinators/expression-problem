...
trait Arithmetic2[T](val _base: AnyParadigm2.WithAST[ArithmeticOpsAST]) {
...
object Arithmetic2 {
  type WithBase[T, AST <: ArithmeticOpsAST, B <: AnyParadigm2.WithAST[AST]] = Arithmetic2[T] {val _base: B}

  trait WB[T, AST <: ArithmeticOpsAST, B <: AnyParadigm2.WithAST[AST]](override val _base: B) extends Arithmetic2[T] {}

  def apply[T, AST <: ArithmeticOpsAST, B <: AnyParadigm2.WithAST[AST]](_base: B): WithBase[T, AST, _base.type] = new WB[T, AST, _base.type](_base) with Arithmetic2[T](_base) {}
}
