package org.combinators.archive.bottomUp.oneSequence.maxsubarray
...
import org.combinators.archive.topDown.oneSequence.tribonacci.TribonacciObjectOrientedProvider
