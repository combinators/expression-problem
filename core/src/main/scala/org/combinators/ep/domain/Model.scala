...
case class Model(name:String, types:Seq[DataType], ops:Seq[Operation], last:Model = Model.empty) {
...
object Model {
  def empty:Model = Model("", Seq.empty, Seq.empty, null)
