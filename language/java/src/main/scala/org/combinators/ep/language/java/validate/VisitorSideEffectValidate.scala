 ...
 */
object VisitorSideEffectValidate extends IOApp with BaseEvolution {

  val approach = VisitorSideEffect[Syntax.default.type, generator.paradigm.type](generator.paradigm)(JavaNameProvider, generator.imperativeInMethod, generator.ooParadigm, generator.parametricPolymorphism)(generator.generics)

  // Massive one-liner, but this aligns with M8   TODO: replace with Ci/CD
  ...
  val eip = eips.M0(approach.paradigm)(generator.doublesInMethod)
