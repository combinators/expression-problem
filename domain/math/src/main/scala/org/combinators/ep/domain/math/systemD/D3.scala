...
object D3 extends Evolution {
  ...
  // Tests
  val d3_s1: DataTypeInstance = SubInst(LitInst(1.0), LitInst(2.0))
  ...
  def tests: Seq[TestCase] = Seq(
    ...
    EqualsTestCase(getModel.baseDataType, d3_s1, PrettyP, StringInst("(1.0-2.0)")),

    EqualsTestCase(getModel.baseDataType, AddInst(d3_s1, AddInst(LitInst(5.0), LitInst(6.0))),
