...
import org.combinators.ep.approach.oo.{CoCoClean, ExtensibleVisitor, Interpreter, RuntimeDispatch, Traditional => TraditionalOO, TriviallyClean}
...
class Main  {
  ...
  /*val m7_eip = eips.M7(approach.paradigm)(m6_eip)(generator.doublesInMethod, generator.realDoublesInMethod, generator.stringsInMethod, generator.functionalInMethod)
