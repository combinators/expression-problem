...
trait Arrays extends Ar {
  override val _base: AnyParadigm { val ast: ArraysAST & BaseAST }
...
object Arrays {
  ...
  ): Arrays.WithBase[base.type, _parametricPolymorphism.type, _oo.type, _generics.type] = {
    class Arrs(
