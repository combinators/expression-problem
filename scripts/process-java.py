# Process jacoco.* output generated by the compile-java.py scripts
# within the directory that was result of generating systems for different approaches
#
#    python3 ..\..\scripts\process-java.py
#
# Best to have two separate process-XXX files because the coverage output is slightly different
# for Java and Scala
