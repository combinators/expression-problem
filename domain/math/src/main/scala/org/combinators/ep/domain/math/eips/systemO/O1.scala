...
object O1 {
  ...
  (ffiArithmetic: Arithmetic.WithBase[paradigm.MethodBodyContext, paradigm.type, Double],
    ...
    val o1Provider = new EvolutionImplementationProvider[AIP[paradigm.type]] {
      override val model = math.systemO.O1.getModel
      ...
      override def dependencies(potentialRequest: PotentialRequest): Option[Set[Operation]] = {
        val cases = math.systemO.O1.getModel.flatten.typeCases
