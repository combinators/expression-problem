...
override val gen = new WithDomain(math.MathDomain) with StraightGenerator with CPPOOTestGenerator with cpp_e0
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with StraightGenerator with CPPOOTestGenerator with cpp_e0 with cpp_e1
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with StraightGenerator with CPPOOTestGenerator with cpp_e0 with cpp_e1 with cpp_e2
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with StraightGenerator with CPPOOTestGenerator with cpp_e0 with cpp_e1 with cpp_e2 with cpp_e3
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with StraightGenerator with CPPOOTestGenerator with cpp_e0 with cpp_e1 with cpp_e2 with cpp_e3 with cpp_e4
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with StraightGenerator with CPPOOTestGenerator with cpp_e0 with cpp_e1 with cpp_e2 with cpp_e3 with cpp_e4 with cpp_e5
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with StraightGenerator with CPPOOTestGenerator with cpp_e0 with cpp_e1 with cpp_e2 with cpp_e3 with cpp_e4 with cpp_e5 with cpp_e6
}
