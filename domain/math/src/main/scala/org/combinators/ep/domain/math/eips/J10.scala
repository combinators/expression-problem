  ...
  EvolutionImplementationProvider[AIP[paradigm.type]] = {
    val j10Provider = new EvolutionImplementationProvider[AIP[paradigm.type]] {
      ...
      def applicable
        ...
        (potentialRequest.op == math.J10.Height) &&
          Set(math.M0.Lit, math.M0.Add, math.J1.Sub,math.J2.Mult,math.J3.Divd,math.J3.Neg,math.J4.Power,math.J9.Inv).contains(potentialRequest.tpeCase)
      }
      ...
      Generator[paradigm.MethodBodyContext, Option[paradigm.syntax.Expression]] = {
        ...
        if (onRequest.request.op == math.J10.Height && onRequest.tpeCase != math.M0.Lit) {
          for {
              ...
              for {
                ...
                exprVal <- forApproach.dispatch(
                  SendRequest(
                    ...
                    Request(math.J10.Height, Map.empty),
                    Some(onRequest)
                  )
                )
          ...
          j9Provider.genericLogic(forApproach)(onRequest)
        }
      }
    ...
    // newest first
    monoidInstance.combine(j10Provider, j9Provider)
  }
}
