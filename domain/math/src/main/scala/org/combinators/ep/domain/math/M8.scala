...
import org.combinators.ep.domain.abstractions.{DataTypeCase, EqualsCompositeTestCase, EqualsTestCase}
...
object M8 extends Evolution {
  ...
  // Tests
  val m8_d1: DataTypeInstance = InvInst(LitInst(5.0), LitInst(2.0))
  val m8_d2: DataTypeInstance = InvInst(LitInst(1.0), LitInst(5.0))
