...
override val gen = new WithDomain(math.MathDomain) with GrowGenerator with GrowTestGenerator with e0
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with GrowGenerator with GrowTestGenerator with e0 with e1
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with GrowGenerator with GrowTestGenerator with e0 with e1 with e2
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with GrowGenerator with GrowTestGenerator with e0 with e1 with e2 with e3
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with GrowGenerator with GrowTestGenerator with e0 with e1 with e2 with e3 with e4
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with GrowGenerator with GrowTestGenerator with e0 with e1 with e2 with e3 with e4 with e5
}
/* 
...
override val gen = new WithDomain(math.MathDomain) with GrowGenerator with GrowTestGenerator with e0 with e1 with e2 with e3 with e4 with e5 with e6
}
