...
class Main {
  ...
  // select one here.
  val approach = extensibleVisitorApproach// cocoCleanApproach//extensibleVisitorApproach

  val evolutions = Seq(M0, M1, M2, M3, M4, I1, I2, M5, M6, M7, M7I2, M8, M9)    // all test cases become active WHEN all included.
