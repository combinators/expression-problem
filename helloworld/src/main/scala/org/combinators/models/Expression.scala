...
class EqualExpression(val left: Expression, val right: Expression, val tpe:ArgumentType = org.combinators.models.IntegerType()) extends Expression with BooleanExpression
