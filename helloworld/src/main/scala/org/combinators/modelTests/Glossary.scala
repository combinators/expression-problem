...
import org.combinators.modelTests.twoSequences.{DistinctSubsequencesMainJava, DistinctSubsequencesToDiskMain, LongestCommonSubsequenceMainJava, LongestCommonSubsequenceToDiskMain, NeedlemanWunschSequenceAlignmentMainJava, NeedlemanWunschSequenceAlignmentToDiskMain, UncrossedLinesDirectDiskToMain, UncrossedLinesMainJava, WildcardPatternMatchingMainJava, WildcardPatternMatchingToDiskMain}
